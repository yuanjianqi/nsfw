...
<head>
    ...
    <script type="text/javascript">
        ...
        function doSearch() {
            ...
            document.forms[0].action = "${basePath}nsfw/user/user_listUI.action";
            document.forms[0].submit();
        }
    </script>
</head>
        ...
        <div class="p_d_1_1">
            <div class="content_info">
                ...
                <div class="search_art">
                    <li>
                        用户名：<s:textfield name="user.username" cssClass="s_text" id="userName" cssStyle="width:160px;"/>
                    </li>
                    ...
                    <li style="float:right;">
                        ...
                        <input name="userExecl" type="file"/>
                ...
                <div class="t_list" style="margin:0px; border:0px none;">
                    <table width="100%" border="0">
                        ...
                        <tr bgcolor="f8f8f8">
                            <td align="center"><input type="checkbox" name="selected" value="<s:property value="id"/> "/></td>
